package com.insiap.test.demo;

import java.util.HashMap;
import java.util.Map;

import cn.ebao.core.util.JSONHelper;
import com.insiap.webapp.util.WebServiceConstants;
import com.insiap.webapp.util.WebServiceUtil;
/*
 * 调用webservice Demo
 */
public class WebServiceTestClient {
    ...
    public static void main(String[] args) {
        ...
        result = WebServiceUtil.SoapWebservice(url, xmlns, method, pamps, SoapHeaderUser, SoapHeaderSign);
        System.out.println(result);
        System.out.println(JSONHelper.json2Map(result).get("AgentCard").toString());
    }
}
