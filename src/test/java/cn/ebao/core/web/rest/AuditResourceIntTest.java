package cn.ebao.core.web.rest;

import cn.ebao.core.InsiapProposalApp;
import cn.ebao.core.config.audit.AuditEventConverter;
import cn.ebao.core.domain.PersistentAuditEvent;
import cn.ebao.core.repository.PersistenceAuditEventRepository;
import cn.ebao.core.service.AuditEventService;
...
@SpringBootTest(classes = InsiapProposalApp.class)
@Transactional
